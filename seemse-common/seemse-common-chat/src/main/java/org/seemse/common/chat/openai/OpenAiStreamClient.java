...
import org.seemse.common.chat.entity.billing.KeyInfo;
...
import org.seemse.common.chat.entity.images.Image;
import org.seemse.common.chat.entity.images.ImageResponse;
import org.seemse.common.chat.entity.models.Model;
import org.seemse.common.chat.entity.models.ModelResponse;
import org.seemse.common.chat.entity.whisper.Transcriptions;
...
import org.seemse.common.chat.sse.DefaultPluginListener;
import org.seemse.common.chat.sse.PluginListener;
...
public class OpenAiStreamClient {
    ...
    private OpenAiStreamClient(Builder builder) {
        ...
        apiKey = Collections.singletonList(OpenAIConst.apiKey);
        ...
        //设置apiKeys和key的获取策略
        authInterceptor.setApiKey(Collections.singletonList(OpenAIConst.apiKey));
...
//        this.authInterceptor.setApiKey(OpenAIConst.apiKey);
        this.authInterceptor.setApiKey(Collections.singletonList(OpenAIConst.apiKey));
