...
import org.seemse.annotation.DataColumn;
import org.seemse.annotation.DataPermission;
...
import org.seemse.enums.DataScopeType;
import org.seemse.helper.DataPermissionHelper;
        ...
        for (RoleDTO role : user.getRoles()) {
            ...
            for (DataColumn dataColumn : dataPermission.value()) {
                ...
                if (ignoreMap.containsKey(dataColumn)) {
                    // 修复多角色与权限标识符共用问题 https://gitee.com/dromara/seemse-Vue-Plus/issues/IB4CS4
