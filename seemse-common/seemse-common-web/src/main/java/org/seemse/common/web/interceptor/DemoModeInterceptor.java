package org.seemse.common.web.interceptor;

import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
import lombok.extern.slf4j.Slf4j;
import org.seemse.common.core.config.SeemseConfig;
import org.seemse.common.core.exception.DemoModeException;
...
public class DemoModeInterceptor implements HandlerInterceptor {
    ...
    @Autowired
    private SeemseConfig seemseConfig;

    @Override
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        // 如果演示模式未开启，直接放行
        if (!seemseConfig.isDemoEnabled()) {
            return true;
        }
