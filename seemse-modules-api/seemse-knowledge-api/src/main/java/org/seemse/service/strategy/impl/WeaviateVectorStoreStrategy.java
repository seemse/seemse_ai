package org.seemse.service.strategy.impl;
...
import org.seemse.common.core.config.VectorStoreProperties;
import org.seemse.domain.bo.QueryVectorBo;
import org.seemse.domain.bo.StoreEmbeddingBo;
import org.seemse.service.strategy.AbstractVectorStoreStrategy;
...
//            log.info("文本: {}, 向量维度: {}, 前3个值: [{}, {}, {}]",
//                    text,
//                    vector.length,
//                    vector.length > 0 ? vector[0] : null,
//                    vector.length > 1 ? vector[1] : null,
//                    vector.length > 2 ? vector[2] : null
//            );
            ...
            if (result.hasErrors()) {
                log.error("插入失败！文本: {}, 错误: {}", text, result.getError());
            } else {
                log.info("插入成功，ID: {}", result.getResult().getId());
            }
        }
